...
class Fun(commands.Cog, name="fun"):
    ...
    @commands.hybrid_command(name="skywind", description="wat")
    async def skywind(self, ctx:Context):
        img_path = Path(__file__).parent / "anydaynow.webp"

        # optionally add text with content="..."
        await ctx.send(
